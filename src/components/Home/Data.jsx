...
const Data = () => {
    return (
        <div className='home__data'>
            <h1 className='home__title'>Salim Rutaganda
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
                ...
                I thrive on solving complex challenges and delivering innovative solutions with a commitment to excellence and mastery.
            </p>
